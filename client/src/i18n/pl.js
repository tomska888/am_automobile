    ...
    admin: {
        ...
        cars: {
            ...
            form: {
                ...
                sectionTech: 'Dane techniczne',
                sectionStatus: 'Status ogłoszenia',
                sectionImages: 'Zdjęcia',
                sectionDesc: 'Opis i wyposażenie',
                make: 'Marka',
                makeRequired: 'Marka jest wymagana',
                makePlaceholder: 'np. BMW, Toyota, Audi',
                model: 'Model',
                modelRequired: 'Model jest wymagany',
                modelPlaceholder: 'np. 3 Series, Corolla, A4',
                year: 'Rok produkcji',
                yearRequired: 'Rok musi być między 1990 a {max}',
                mileage: 'Przebieg (km)',
                mileagePlaceholder: '45000',
                fuelType: 'Rodzaj paliwa',
                fuelTypeRequired: 'Wybierz rodzaj paliwa',
                ...
                transManual: 'Manualna',
                transAutomatic: 'Automatyczna',
                transSemi: 'Półautomatyczna',
                transCvt: 'CVT',
                bodyType: 'Typ nadwozia',
                bodyPlaceholder: 'Wybierz nadwozie...',
                bodySedan: 'Sedan',
                ...
                featured: 'Wyróżnione ogłoszenie (pojawi się na stronie głównej)',
                mainImage: 'Główne zdjęcie',
                gallery: 'Zdjęcia galerii',
                uploadDrop: 'Upuść zdjęcia tutaj lub kliknij, aby wybrać',
                uploadDropActive: 'Upuść zdjęcia, aby przesłać',
                uploadHint: 'JPEG, PNG, WebP — maks. 15 MB każde, do 20 zdjęć łącznie',
                uploadBtn: 'Wybierz zdjęcia',
                uploading: 'Przesyłanie…',
                uploadError: 'Błąd przesyłania. Spróbuj ponownie.',
                uploadErrorSize: 'Plik „{name}" jest za duży (maks. 15 MB)',
                uploadErrorType: 'Plik „{name}" nie jest prawidłowym obrazem',
                removePhoto: 'Usuń zdjęcie',
                setAsMain: 'Ustaw jako główne',
                mainBadge: 'Główne',
                photosCount: '{count} zdjęcie | {count} zdjęcia | {count} zdjęć',
                imagePreviewError: 'Nie można załadować obrazu',
                description: 'Opis pojazdu',
                descriptionPlaceholder: 'Opisz pojazd, jego historię, stan techniczny, wyposażenie...',
                descriptionHint: '{count} / 2000 znaków',
                features: 'Wyposażenie dodatkowe (jedno na linię)',
                featuresHint: 'Wpisz każdą funkcję w osobnej linii.',
                cancel: 'Anuluj',
                saving: 'Zapisywanie...',
